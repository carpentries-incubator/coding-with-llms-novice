...
The following prompt templates are included as starting points for exploration, to be adapted in
a way that best suits your needs and workflow.

> **FIXME** The following prompt is copied from the [Maastricht University AI Prompt Library](https://library.maastrichtuniversity.nl/apps-tools/ai-prompt-library/learning-supported-by-ai-prompts/)
> . If we choose to run with it, we need to adapt it for this course.
